...
def main(args):
  ...
  bkg_to_optim = pd.DataFrame({"mass":data.Diphoton_mass, "weight":data.weight, "score":data[args.score]})
  sig_to_optim = pd.DataFrame({"mass":sig.Diphoton_mass, "weight":sig.weight, "score":sig[args.score]})
