...
train_features['important'] = ["SubleadPhoton_pt", "category", "SubleadPhoton_lead_lepton_dR", "diphoton_met_dPhi", "b_jet_1_btagDeepFlavB", "Diphoton_dR", "dilep_leadpho_mass", "jet_1_pt", "Diphoton_deta", "SubleadPhoton_genPartFlav", "LeadPhoton_pt", "reco_MggtauMET", "Diphoton_dPhi", "Diphoton_lead_lepton_dphi", "lead_lepton_eta", "n_taus", "Diphoton_lead_lepton_deta", "ditau_met_dPhi", "MET_pt", "Diphoton_sublead_lepton_dphi", "ditau_pt", "LeadPhoton_lead_lepton_dR", "SubleadPhoton_mvaID", "Diphoton_pt_mgg", "Diphoton_lead_lepton_dR", "reco_MX_MET", "lead_lepton_pt", "ditau_mass", "lead_lepton_mass", "Diphoton_min_mvaID", "LeadPhoton_genPartFlav", "ditau_dR", "Diphoton_ditau_dphi", "reco_MX", "jet_2_pt", "Diphoton_helicity"]
